...
class App extends React.Component {
  ...
  loadQuestions() {
    ...
    let newLoadTimer = setInterval(function (this_app) {
    ...
    , 100, this);
    this.setState({loadTimer: newLoadTimer});
  }
  ...
  startGame() {
    ...
    if (this.state.questionData.results.length < NUMBER_OF_QUESTIONS) {
      ...
      let newGameTimer = setInterval(this.timerForGame, 1000, this);
      this.setState({gameTimer: newGameTimer});
    }
  }
